!function(exports) {
    ...
    if ("undefined" != typeof kg) {
        var Messenger = function() {
            var Messenger = {}, messages = {};
            return Messenger.on = function(message, fn, ctx) {
                var shouldAdd = !0, ctx = ctx || exports;
                ...
                shouldAdd && messages[message].push({
                    fn: fn,
                    ctx: ctx
                });
            }, Messenger.off = function(message, fn) {
                if ("undefined" == typeof message && messages[message]) {
                    if ("undefined" == typeof fn) return void delete messages[message];
                    for (var i = 0; i < messages[message].length; i++) {
                        var obj = messages[message][i];
                        if (obj.fn === fn) return void messages[message].splice(i, 1);
                    }
                }
            }, Messenger.broadcast = function(message, data) {
                if (!messages[message]) return !1;
                for (var i = 0; i < messages[message].length; i++) {
                    var obj = messages[message][i], fn = obj.fn, ctx = obj.ctx;
                    "function" == typeof fn && fn.call(ctx || exports, data);
                }
            }, Messenger;
        }();
